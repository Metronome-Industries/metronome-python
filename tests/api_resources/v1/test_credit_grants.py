...
from metronome.types.v1 import CreditGrantCreateResponse, CreditGrantListResponse, CreditGrantEditResponse, CreditGrantListEntriesResponse, CreditGrantVoidResponse

from metronome._utils import parse_datetime

from typing import cast, Any

from metronome.pagination import SyncCursorPage, SyncCursorPageWithoutLimit, AsyncCursorPage, AsyncCursorPageWithoutLimit
...
from metronome.types.v1 import credit_grant_create_params
from metronome.types.v1 import credit_grant_list_params
from metronome.types.v1 import credit_grant_edit_params
from metronome.types.v1 import credit_grant_list_entries_params
from metronome.types.v1 import credit_grant_void_params
...
class TestAsyncCreditGrants:
    ...
    async def test_method_list_entries(self, async_client: AsyncMetronome) -> None:
        ...
        assert_matches_type(AsyncCursorPageWithoutLimit[CreditGrantListEntriesResponse], credit_grant, path=['response'])
