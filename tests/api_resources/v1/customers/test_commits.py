...
class TestCommits:
    ...
    def test_method_list(self, client: Metronome) -> None:
        ...
        assert_matches_type(SyncBodyCursorPage[CommitListResponse], commit, path=["response"])
...
class TestAsyncCommits:
    ...
    async def test_method_list(self, async_client: AsyncMetronome) -> None:
        ...
        assert_matches_type(AsyncBodyCursorPage[CommitListResponse], commit, path=["response"])
