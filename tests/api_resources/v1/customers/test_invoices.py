...
from metronome.types.v1.customers import InvoiceRetrieveResponse, Invoice, InvoiceAddChargeResponse, InvoiceListBreakdownsResponse
...
from metronome._response import BinaryAPIResponse, StreamedBinaryAPIResponse, AsyncBinaryAPIResponse, AsyncStreamedBinaryAPIResponse
...
from metronome.types.v1.customers import invoice_retrieve_params
from metronome.types.v1.customers import invoice_list_params
from metronome.types.v1.customers import invoice_add_charge_params
from metronome.types.v1.customers import invoice_list_breakdowns_params
...
class TestInvoices:
    ...
    def test_method_retrieve_pdf(self, client: Metronome, respx_mock: MockRouter) -> None:
        respx_mock.get("/v1/customers/d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc/invoices/6a37bb88-8538-48c5-b37b-a41c836328bd/pdf").mock(
