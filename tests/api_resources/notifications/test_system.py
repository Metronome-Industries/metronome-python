...
class TestSystem:
    ...
    def test_method_list(self, client: Metronome) -> None:
        system = client.notifications.system.list()
        assert_matches_type(SystemListResponse, system, path=["response"])

    @parametrize
    def test_raw_response_list(self, client: Metronome) -> None:
        response = client.notifications.system.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Metronome) -> None:
        with client.notifications.system.with_streaming_response.list() as response:
...
class TestAsyncSystem:
    ...
    async def test_method_list(self, async_client: AsyncMetronome) -> None:
        system = await async_client.notifications.system.list()
        assert_matches_type(SystemListResponse, system, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncMetronome) -> None:
        response = await async_client.notifications.system.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncMetronome) -> None:
        async with async_client.notifications.system.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
