...
from metronome.types.contracts.rate_cards import rate_list_params
from metronome.types.contracts.rate_cards import rate_add_params
from metronome.types.contracts.rate_cards import rate_add_many_params
...
class TestRates:
    ...
    def test_method_list(self, client: Metronome) -> None:
        rate = client.contracts.rate_cards.rates.list(
    ...
    def test_raw_response_list(self, client: Metronome) -> None:
        ...
        response = client.contracts.rate_cards.rates.with_raw_response.list(
            at=parse_datetime("2024-01-01T00:00:00.000Z"),
            rate_card_id="f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe",
        )
    ...
    def test_streaming_response_list(self, client: Metronome) -> None:
        with client.contracts.rate_cards.rates.with_streaming_response.list(
            at=parse_datetime("2024-01-01T00:00:00.000Z"),
            rate_card_id="f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe",
        ) as response :
    ...
    def test_method_add(self, client: Metronome) -> None:
        rate = client.contracts.rate_cards.rates.add(
            entitled=True,
    ...
    def test_raw_response_add(self, client: Metronome) -> None:
        ...
        response = client.contracts.rate_cards.rates.with_raw_response.add(
            entitled=True,
            product_id="13117714-3f05-48e5-a6e9-a66093f13b4d",
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            rate_type="FLAT",
    ...
    def test_streaming_response_add(self, client: Metronome) -> None:
        with client.contracts.rate_cards.rates.with_streaming_response.add(
            entitled=True,
            product_id="13117714-3f05-48e5-a6e9-a66093f13b4d",
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            rate_type="FLAT",
...
class TestAsyncRates:
    ...
    async def test_method_list(self, async_client: AsyncMetronome) -> None:
        rate = await async_client.contracts.rate_cards.rates.list(
            at=parse_datetime("2024-01-01T00:00:00.000Z"),
            rate_card_id="f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe",
        )
    ...
    async def test_raw_response_list(self, async_client: AsyncMetronome) -> None:
        ...
        response = await async_client.contracts.rate_cards.rates.with_raw_response.list(
            at=parse_datetime("2024-01-01T00:00:00.000Z"),
            rate_card_id="f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncMetronome) -> None:
        async with async_client.contracts.rate_cards.rates.with_streaming_response.list(
            at=parse_datetime("2024-01-01T00:00:00.000Z"),
            rate_card_id="f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe",
        ) as response :
            assert not response.is_closed
    ...
    async def test_method_add(self, async_client: AsyncMetronome) -> None:
        rate = await async_client.contracts.rate_cards.rates.add(
            entitled=True,
            product_id="13117714-3f05-48e5-a6e9-a66093f13b4d",
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            rate_type="FLAT",
    ...
    async def test_raw_response_add(self, async_client: AsyncMetronome) -> None:
        ...
        response = await async_client.contracts.rate_cards.rates.with_raw_response.add(
            entitled=True,
            product_id="13117714-3f05-48e5-a6e9-a66093f13b4d",
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            rate_type="FLAT",
    ...
    async def test_streaming_response_add(self, async_client: AsyncMetronome) -> None:
        async with async_client.contracts.rate_cards.rates.with_streaming_response.add(
            entitled=True,
            product_id="13117714-3f05-48e5-a6e9-a66093f13b4d",
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            rate_type="FLAT",
