...
from metronome.types.contracts.rate_cards import product_order_update_params
from metronome.types.contracts.rate_cards import product_order_set_params
...
class TestProductOrders:
    ...
    def test_method_set(self, client: Metronome) -> None:
        product_order = client.contracts.rate_cards.product_orders.set(
    ...
    def test_raw_response_set(self, client: Metronome) -> None:
        ...
        response = client.contracts.rate_cards.product_orders.with_raw_response.set(
            product_order=["13117714-3f05-48e5-a6e9-a66093f13b4d", "b086f2f4-9851-4466-9ca0-30d53e6a42ac"],
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
        )
    ...
    def test_streaming_response_set(self, client: Metronome) -> None:
        with client.contracts.rate_cards.product_orders.with_streaming_response.set(
            product_order=["13117714-3f05-48e5-a6e9-a66093f13b4d", "b086f2f4-9851-4466-9ca0-30d53e6a42ac"],
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
        ) as response :
            assert not response.is_closed
...
class TestAsyncProductOrders:
    ...
    async def test_method_set(self, async_client: AsyncMetronome) -> None:
        product_order = await async_client.contracts.rate_cards.product_orders.set(
            product_order=["13117714-3f05-48e5-a6e9-a66093f13b4d", "b086f2f4-9851-4466-9ca0-30d53e6a42ac"],
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
        )
        assert_matches_type(ProductOrderSetResponse, product_order, path=['response'])
    ...
    async def test_raw_response_set(self, async_client: AsyncMetronome) -> None:
        ...
        response = await async_client.contracts.rate_cards.product_orders.with_raw_response.set(
            product_order=["13117714-3f05-48e5-a6e9-a66093f13b4d", "b086f2f4-9851-4466-9ca0-30d53e6a42ac"],
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
        )
    ...
    async def test_streaming_response_set(self, async_client: AsyncMetronome) -> None:
        async with async_client.contracts.rate_cards.product_orders.with_streaming_response.set(
            product_order=["13117714-3f05-48e5-a6e9-a66093f13b4d", "b086f2f4-9851-4466-9ca0-30d53e6a42ac"],
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
        ) as response :
            assert not response.is_closed
