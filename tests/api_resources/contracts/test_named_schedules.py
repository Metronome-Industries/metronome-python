...
from metronome.types.contracts import named_schedule_retrieve_params
from metronome.types.contracts import named_schedule_update_params
...
class TestNamedSchedules:
    ...
    def test_method_retrieve(self, client: Metronome) -> None:
        named_schedule = client.contracts.named_schedules.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Metronome) -> None:
        ...
        response = client.contracts.named_schedules.with_raw_response.retrieve(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
        )
    ...
    def test_streaming_response_retrieve(self, client: Metronome) -> None:
        with client.contracts.named_schedules.with_streaming_response.retrieve(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
        ) as response :
    ...
    def test_method_update(self, client: Metronome) -> None:
        named_schedule = client.contracts.named_schedules.update(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
    ...
    def test_raw_response_update(self, client: Metronome) -> None:
        ...
        response = client.contracts.named_schedules.with_raw_response.update(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
            starting_at=parse_datetime("2022-02-01T00:00:00Z"),
            value={
    ...
    def test_streaming_response_update(self, client: Metronome) -> None:
        with client.contracts.named_schedules.with_streaming_response.update(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
            starting_at=parse_datetime("2022-02-01T00:00:00Z"),
            value={
...
class TestAsyncNamedSchedules:
    ...
    async def test_method_retrieve(self, async_client: AsyncMetronome) -> None:
        named_schedule = await async_client.contracts.named_schedules.retrieve(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
        )
        assert_matches_type(NamedScheduleRetrieveResponse, named_schedule, path=['response'])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncMetronome) -> None:
        ...
        response = await async_client.contracts.named_schedules.with_raw_response.retrieve(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncMetronome) -> None:
        async with async_client.contracts.named_schedules.with_streaming_response.retrieve(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
        ) as response :
            assert not response.is_closed
    ...
    async def test_method_update(self, async_client: AsyncMetronome) -> None:
        named_schedule = await async_client.contracts.named_schedules.update(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
            starting_at=parse_datetime("2022-02-01T00:00:00Z"),
            value={
    ...
    async def test_raw_response_update(self, async_client: AsyncMetronome) -> None:
        ...
        response = await async_client.contracts.named_schedules.with_raw_response.update(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
            starting_at=parse_datetime("2022-02-01T00:00:00Z"),
            value={
    ...
    async def test_streaming_response_update(self, async_client: AsyncMetronome) -> None:
        async with async_client.contracts.named_schedules.with_streaming_response.update(
            rate_card_id="d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc",
            schedule_name="my-schedule",
            starting_at=parse_datetime("2022-02-01T00:00:00Z"),
            value={
