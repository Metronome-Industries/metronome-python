...
__all__ = [
    ...
    "DataUnionMember0HierarchyConfiguration",
    "DataUnionMember0HierarchyConfigurationChildAccess",
    "DataUnionMember0HierarchyConfigurationChildAccessType",
    "DataUnionMember0HierarchyConfigurationChildAccessUnionMember2",
    ...
    "DataUnionMember0LedgerUnionMember13",
    ...
    "DataUnionMember1HierarchyConfiguration",
    "DataUnionMember1HierarchyConfigurationChildAccess",
    "DataUnionMember1HierarchyConfigurationChildAccessType",
    "DataUnionMember1HierarchyConfigurationChildAccessUnionMember2",
    ...
    "DataUnionMember1LedgerUnionMember6",
...
class DataUnionMember0HierarchyConfigurationChildAccessType(BaseModel):
    type: Literal["ALL"]


class DataUnionMember0HierarchyConfigurationChildAccessUnionMember2(BaseModel):
    contract_ids: List[str]

    type: Literal["CONTRACT_IDS"]


DataUnionMember0HierarchyConfigurationChildAccess: TypeAlias = Union[
    DataUnionMember0HierarchyConfigurationChildAccessType,
    DataUnionMember0HierarchyConfigurationChildAccessType,
    DataUnionMember0HierarchyConfigurationChildAccessUnionMember2,
]
...
class DataUnionMember0HierarchyConfiguration(BaseModel):
    child_access: DataUnionMember0HierarchyConfigurationChildAccess
...
class DataUnionMember0LedgerUnionMember13(BaseModel):
    amount: float
...
class DataUnionMember0(BaseModel):
    ...
    hierarchy_configuration: Optional[DataUnionMember0HierarchyConfiguration] = None
...
class DataUnionMember1HierarchyConfigurationChildAccessType(BaseModel):
    type: Literal["ALL"]


class DataUnionMember1HierarchyConfigurationChildAccessUnionMember2(BaseModel):
    contract_ids: List[str]

    type: Literal["CONTRACT_IDS"]


DataUnionMember1HierarchyConfigurationChildAccess: TypeAlias = Union[
    DataUnionMember1HierarchyConfigurationChildAccessType,
    DataUnionMember1HierarchyConfigurationChildAccessType,
    DataUnionMember1HierarchyConfigurationChildAccessUnionMember2,
]
...
class DataUnionMember1HierarchyConfiguration(BaseModel):
    child_access: DataUnionMember1HierarchyConfigurationChildAccess
...
class DataUnionMember1LedgerUnionMember6(BaseModel):
    amount: float
...
class DataUnionMember1(BaseModel):
    ...
    hierarchy_configuration: Optional[DataUnionMember1HierarchyConfiguration] = None
