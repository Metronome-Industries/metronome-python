...
__all__ = [
    ...
    "DataCurrentThresholdBillingConfigurationCommit",
    ...
    "DataInitialThresholdBillingConfigurationCommit",
...
class DataCurrentThresholdBillingConfigurationCommit(BaseModel):
    product_id: str
...
class DataCurrentThresholdBillingConfiguration(BaseModel):
    commit: DataCurrentThresholdBillingConfigurationCommit
...
class DataInitialThresholdBillingConfigurationCommit(BaseModel):
    product_id: str
...
class DataInitialThresholdBillingConfiguration(BaseModel):
    commit: DataInitialThresholdBillingConfigurationCommit
