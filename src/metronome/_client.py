...
from .resources import alerts, plans, credit_grants, pricing_units, dashboards, usage, audit_logs, custom_fields, billable_metrics, services, invoices
...
class Metronome(SyncAPIClient):
    ...
    def __init__(self, *, bearer_token: str | None = None, webhook_secret: str | None = None, base_url: str | httpx.URL | None = None, timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN, max_retries: int = DEFAULT_MAX_RETRIES, default_headers: Mapping[str, str] | None = None, default_query: Mapping[str, object] | None = None, 
...
class AsyncMetronomeWithStreamedResponse:
    def __init__(self, client: AsyncMetronome) -> None:
        ...
        self.billable_metrics = billable_metrics.AsyncBillableMetricsResourceWithStreamingResponse(client.billable_metrics)
